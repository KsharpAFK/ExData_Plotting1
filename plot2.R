## Plot 2 creates the required line graph
...
## Open png device and use use plot() function to plot datetime vs Global active power
## Specify type = "l" to make a line graph
